...
class IntermediarySales extends StatefulWidget {
  const IntermediarySales({super.key});

  @override
  State<IntermediarySales> createState() => _IntermediarySalesState();
}

class _IntermediarySalesState extends BaseScreenState<IntermediarySales> {
  DateTime selectedDate = DateTime.now();
  String saleTime = DateFormat('hh:mm a').format(DateTime.now()).toString();
  ElectricianInfo? selectedElectrician;
  ...
  void _handleDateSelected(DateTime value, String type) {
    setState(() {
      ...
      isButtonEnabled = (selectedElectrician != null);
    });
  }

  void _handleElectricianSelected(ElectricianInfo value, String type) {
    setState(() {
      selectedElectrician = value;
      isButtonEnabled = (selectedElectrician != null);
    });
  }
          ...
          child: Column(
              ...
              children: [
                HeadingRegisterSales(
                  ...
                  heading: "${translation(context).intermediarySales}",
            ...
            Container(
              ...
              child: Text(
                translation(context).saleToElectrician,
              ...
              children: [
                Column(
                  children: [
                    DropdownBSWidget(
                        saleType: "Intermediary",
                        labelText: "${translation(context).electricianName} (Code)",
                        hintText: translation(context).electricianName,
                        icon: Icon(Icons.keyboard_arrow_down),
                        dropDownType: "SearchableList",
                        onDateSelected: (value, type) {
                          _handleDateSelected(value, type);
                        },
                      onElectricianSelected: (value, type) {
                        _handleElectricianSelected(value, type);
                      }
                    ),
                    Container(
                   ...
                   /* DropdownBSWidget(
                      saleType: "Intermediary",
                      labelText: translation(context).saleDate,
                ...
                Align(
                  ...
                  child:  CommonButton(
                      ...
                      onPressed: isButtonEnabled ? _navigateToQRScanner : null,
