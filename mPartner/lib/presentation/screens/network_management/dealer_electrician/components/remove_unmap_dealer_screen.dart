...
class RemoveUnmapDealerScreen extends StatefulWidget {
  final Function(String) onItemSelected;
  final String? contentTiltle;
  final String? path;
  final String? message;

  const RemoveUnmapDealerScreen(
      {required this.onItemSelected, this.contentTiltle, this.path,this.message, super.key});

  @override
  State<RemoveUnmapDealerScreen> createState() =>
      _RemoveUnmapDealerScreen();
}

class _RemoveUnmapDealerScreen extends State<RemoveUnmapDealerScreen> {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(widget.message.toString(), style: GoogleFonts.poppins(
