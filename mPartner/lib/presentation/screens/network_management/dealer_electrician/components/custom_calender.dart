...
double variablePixelHeight =
    DisplayMethods(context: authController.buildContext!)
        .getVariablePixelHeight();
double variablePixelWidth =
    DisplayMethods(context: authController.buildContext!)
        .getVariablePixelWidth();
double variablePixelMultiplier =
    DisplayMethods(context: authController.buildContext!).getPixelMultiplier();
double variableTextMultiplier =
    DisplayMethods(context: authController.buildContext!)
        .getTextFontMultiplier();
...
Future<void> showCustomDatePicker({
  ...
  String? type,
  Function(DateTime onSelectedDate)? onSelectedDate,
}) async {
  ...
  return CommonBottomSheet.show(
      context, dialog, variablePixelHeight, variablePixelWidth);
...
class DatePickerDialog extends StatefulWidget {
  ...
  ///
  ///
  final Function(DateTime onSelectedDate) onSelectedDate;
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  void _handleOk() {
    ...
    if (cashHistory.type == "from") {
      cashHistory.fromDate.value = _selectedDate.value!;
    } else if (cashHistory.type == "to") {
      cashHistory.toDate.value = _selectedDate.value!;
    } else
    ...
    widget.onSelectedDate(_selectedDate.value!);
  ...
  void _handleCancel() {
    ISmartCashHistoryController cashHistory = Get.find();
    if (cashHistory.type == "from") {
      cashHistory.fromDate.value = DateTime.now();
    } else if (cashHistory.type == "to") {
      cashHistory.toDate.value = DateTime.now();
    } else
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = Container(
      ...
      constraints: BoxConstraints(minHeight: 52.0 * variablePixelHeight),
      //   padding: const EdgeInsets.symmetric(horizontal: 8),
      child: OverflowBar(
        spacing: 8,
        children: <Widget>[
          /*  TextButton(
            //            style: ButtonStyle(backgroundColor:  MaterialStateProperty.all(AppColors.lumiBluePrimary) ),
            style:
    ...
    return Dialog(
      ...
      insetPadding: EdgeInsets.only(
          left: 1.0 * variablePixelWidth, right: 20.0 * variablePixelWidth),
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color? foregroundColor = Colors.transparent;
          ...
          child: Material(
            ...
            child: Container(
              padding: EdgeInsetsDirectional.only(
                start: 14 * variablePixelWidth,
                end: 2 * variablePixelWidth,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  help,
                  Flexible(child: SizedBox(height: 38 * variablePixelHeight)),
                  Row(
                    children: <Widget>[
...
Future<void> showCustomDateRangePicker({
  ...
  final Icon? switchToInputEntryModeIcon,
  final Icon? switchToCalendarEntryModeIcon,
  required Function(DateTimeRange) onSelectStartEndDate,
}) async {
  assert(
  ...
  CommonBottomSheet.show(
      context,
      Container(height: 600 * variablePixelHeight, child: dialog),
      variablePixelHeight,
      variablePixelWidth);
...
class DateRangePickerDialog extends StatefulWidget {
  ...
  const DateRangePickerDialog({
    ...
    this.switchToInputEntryModeIcon,
    this.switchToCalendarEntryModeIcon,
    required this.onSelectStartEndDate,
  });
  ...
  final Function(DateTimeRange) onSelectStartEndDate;
...
class _DateRangePickerDialogState extends State<DateRangePickerDialog>
  ...
  void _handleOk() {
    ...
    widget.onSelectStartEndDate(selectedRange!);
      ...
      switch (_entryMode.value) {
        ...
        case DatePickerEntryMode.input:
          ...
          if (_selectedStart.value != null &&
              (_selectedStart.value!.isBefore(firstDate!) ||
                  _selectedStart.value!.isAfter(lastDate!))) {
          ...
          if (_selectedEnd.value != null &&
              (_selectedEnd.value!.isBefore(firstDate!) ||
                  _selectedEnd.value!.isAfter(lastDate!))) {
            _selectedEnd.value = null;
          }
  ...
  void _handleEndDateChanged(DateTime? date) {
    if (date != null) {
      DateTime selectStart = DateTime(_selectedStart.value!.year,
          _selectedStart.value!.month, _selectedStart.value!.day);
      DateTime selectEnd = DateTime(date!.year, date.month, date.day);
      errorTextValue = "";
      if (widget.daysRange == null) {
        setState(() => _selectedEnd.value = date);
      } else {
        if (selectEnd.difference(selectStart).inDays <= (widget.daysRange!)) {
          setState(() => _selectedEnd.value = date);
        } else {
          errorTextValue = translation(context).secondaryReportDateFilterErrorText;
          _selectedEnd.value = null;
          setState(() {});
        }
      }
    ...
    switch (_entryMode.value) {
      ...
      case DatePickerEntryMode.inputOnly:
        ...
        insetPadding = EdgeInsets.symmetric(
            horizontal: 16.0 * variablePixelWidth,
            vertical: 24.0 * variablePixelHeight);
    }
...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final DatePickerThemeData themeData = DatePickerTheme.of(context);
    final DatePickerThemeData defaults = DatePickerTheme.defaults(context);
    final Color? dialogBackground = AppColors.white;
    ...
    if (authController.isCalendarAtFirst) {
      authController.isCalendarAtFirst = false;
      startDateController.text = "DD/MM/YYYY";
      endDateController.text = "DD/MM/YYYY";
    } else {
      startDateController.text =
          startDateText.isNotEmpty ? startDateText : "DD/MM/YYYY";
      endDateController.text =
          endDateText.isNotEmpty && !endDateText.contains("End")
              ? endDateText
              : "DD/MM/YYYY";
    }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          preferredSize: Size(double.infinity, 84 * variablePixelHeight),
          child: Row(children: <Widget>[
            SizedBox(width: 22 * variablePixelWidth),
            Expanded(
              child: Semantics(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              style: GoogleFonts.poppins(
                                  ...
                                  fontWeight: FontWeight.w500,
                                  color: startDateText.isNotEmpty &&
                                          !startDateText.contains("Start")
            ...
            if (orientation == Orientation.portrait && entryModeButton != null)
              Padding(
                padding:
                    EdgeInsets.symmetric(horizontal: 8.0 * variablePixelWidth),
                child: IconTheme(
                  data: iconTheme,
                  child: entryModeButton!,
                ),
...
double _monthItemRowHeight = 42.0 * variablePixelHeight;
const double _monthItemSpaceBetweenRows = 8.0;
double _horizontalPadding = 8.0 * variablePixelWidth;
const double _maxCalendarWidthLandscape = 384.0;
double _maxCalendarWidthPortrait = 480.0 * variablePixelWidth;
...
class _DayHeaders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyle = themeData.textTheme.titleSmall!
        .apply(color: AppColors.black, fontSizeFactor: 0.8, fontWeightDelta: 0);
    final MaterialLocalizations localizations =
        MaterialLocalizations.of(context);
...
class _MonthItemState extends State<_MonthItem> {
  ...
  Color _highlightColor(BuildContext context) {
    if (widget.daysRange == null) {
      return AppColors.dateRangeColor;
    } else {
      return (widget.selectedDateEnd != null &&
              widget.selectedDateStart != null)
          ? (widget.selectedDateEnd!
                      .difference(widget.selectedDateStart!)
                      .inDays <=
          widget.daysRange!)
              ? AppColors.dateRangeColor
              : AppColors
                  .transparent /*DatePickerTheme.of(context).rangeSelectionBackgroundColor
  ...
  Widget _buildDayItem(BuildContext context, DateTime dayToBuild,
    ...
    TextStyle? itemStyle = textTheme.bodyMedium?.apply(fontSizeFactor: 0.8);
    ...
    if (isSelectedDayStart || isSelectedDayEnd) {
      ...
      itemStyle = textTheme.bodyMedium
          ?.apply(color: dayForegroundColor, fontSizeFactor: 0.8);
      ...
      if (isRangeSelected &&
        ...
        if (widget.daysRange == null) {
          ...
          highlightPainter = _HighlightPainter(
            color: AppColors.dateRangeColor,
            style: style,
            textDirection: textDirection,
          );
        } else {
          if (widget.selectedDateEnd!
                  .difference(widget.selectedDateStart!)
                  .inDays <=
              widget.daysRange!) {
            final _HighlightPainterStyle style = isSelectedDayStart
      ...
      itemStyle = textTheme.bodyMedium
          ?.apply(color: AppColors.lightGreyBorder, fontSizeFactor: 0.8);
    } else if (DateUtils.isSameDay(widget.currentDate, dayToBuild)) {
      // The current day gets a different text color and a circle stroke
      // border.
      itemStyle = textTheme.bodyMedium
          ?.apply(color: AppColors.lumiBluePrimary, fontSizeFactor: 0.8);
            ...
            child: Container(
              child: Text(
                ...
                style: textTheme.titleMedium!
                    .apply(color: AppColors.black, fontSizeFactor: 0.9),
              ),
            ),
          ),
        ),
